...
class Product extends Generator{
    ...
    public function insert(){
        ...
        "<br>vlBaseAluguel " . $this->getvlBaseAluguel().
        "<br>tipo " . $this->gettipo().
        "<br>anotacoes " . $this->getanotacoes().
        "<br>idFornecedor " . $this->getidFornecedor().
        "<br>idCategoria " . $this->getidCategoria();*/

        if(($this->getcodigo() != "") && ($this->getdescricao() != "") && ($this->getstatus() != "")){
           
            $results = $sql->select("CALL sp_produtos_save(:codigo, :descricao, :valorCompra, :valorAluguel, :status, :dtFabricacao, :vlBaseAluguel, :tipo, :anotacoes, :idFornecedor, :idCategoria)", array(
    ...
    public function update(){
        ...
        $results = $sql->select("CALL sp_produtosUpdate_save(:idProduto, :codigo, :descricao, :valorCompra, :valorAluguel, :status, :dtFabricacao, :vlBaseAluguel, :tipo, :anotacoes, :idFornecedor, :idCategoria)", array(
