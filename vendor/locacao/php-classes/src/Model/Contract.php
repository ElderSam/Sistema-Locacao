...
class Contract extends Budget{
    ...
    public function getContractsCostumer($idCliente){
        ...
        $results = $sql->select("SELECT a.idContrato, a.codContrato, a.statusOrcamento as status,
            a.obra_idObra as idObra, b.id_fk_cliente as idCliente
            FROM contratos a
    ...
    public function getValuesToContractPDF($idContract){
        ...
        $results = $sql->select("SELECT c.*, b.endereco AS enderecoObra, b.complemento AS complementoObra, b.bairro AS bairroObra,
    ...
    public function getValuesToCompanyPDF(){
